...
fastify.post('/api/refine-garment', async (request, reply) => {
    ...
    try {
        ...
        if (source === 'ebay') {
            image = image
                .modulate({ brightness: 1.05, contrast: 1.2 }) // Increase contrast for vintage items
    ...
    try {
        ...
        let image = sharp({
            ...
            .withMetadata({
                exif: {
                    IFD0: {
                        ImageDescription: `IdentityID:${identity_id || 'unknown'}`,
                ...
                xmp: Buffer.from(`
                    <x:xmpmeta xmlns:x="adobe:ns:meta/">
                      <rdf:RDF xmlns:rdf="http://www.w3.org/1999/02/22-rdf-syntax-ns#">
                        <rdf:Description rdf:about="" xmlns:c2pa="http://c2pa.org/ns/declaration/" xmlns:dc="http://purl.org/dc/elements/1.1/">
                          <c2pa:declaration>AI-Generated by Antigravity</c2pa:declaration>
                          <dc:creator><rdf:Seq><rdf:li>Antigravity AI</rdf:li></rdf:Seq></dc:creator>
